...
def calculate_top_5(app, user_download_history):
	...
	sorted_tops = sorted(app_similarity.items(), key=operator.itemgetter(1), reverse=True)
	top_5_app = [sorted_tops[0][0], sorted_tops[1][0], sorted_tops[2][0], sorted_tops[3][0], sorted_tops[4][0]]
